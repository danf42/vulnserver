...
This repository contains all of the custom developed tools and proof of concept exploits I've created while working through Vulnserver and the CTP Course.  All learning and development was done using the BackTrack VM provided with the CTP material.  Some of the tools and all of the exploits use Python2.      

### Custom Tools
Tools I have developed to facilitate proof of concept development against Vulnserver and labs in the CTP course.  
